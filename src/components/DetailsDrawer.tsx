  ...
  return (
    ...
    >
      <Drawer.Content ref={setPanelRef} className={DRAWER_PANEL_ANIMATION}>
        <div className="flex h-full w-full flex-col items-start bg-default-background sm:w-[480px]">
          <div className="flex w-full flex-none items-start justify-between gap-2 border-b border-solid border-neutral-border bg-white px-3 py-3 sm:gap-4 sm:px-6 sm:py-4">
            ...
            <div className="-mr-2 flex-none p-2">
              <IconButton
                icon={<FeatherX />}
          ...
          <div
            className={`flex w-full grow shrink-0 basis-0 flex-col items-start gap-4 overflow-y-auto overflow-x-hidden p-3 sm:p-4${bodyClassName ? ` ${bodyClassName}` : ""}`}
          >
            {children}
          </div>
        </div>
